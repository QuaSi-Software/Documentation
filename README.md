...
3. Run `mkdocs serve --open` in the local folder of the repository. This will build and open a local version of the documentation in your default web browser.
